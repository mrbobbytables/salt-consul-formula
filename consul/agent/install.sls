...
sync-consul-agent-ssl-ca:
  file.managed:
  - name: {{ salt['file.join'](agent_settings.ssl.dir, agent_settings.ssl.ca.name) }}
...
sync-consul-agent-ssl-cert:
  file.managed:
  - name: {{ salt['file.join'](agent_settings.ssl.dir, agent_settings.ssl.cert.name) }}
...
sync-consul-agent-ssl-key:
  file.managed:
  - name: {{ salt['file.join'](agent_settings.ssl.dir, agent_settings.ssl.key.name) }}
